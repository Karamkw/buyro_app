import 'package:buyro_app/controller/other/changepassword_controller.dart';
...
class ChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ChangePasswordControllerImp controller = Get.put(
      ChangePasswordControllerImp(token:token),
    );
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
